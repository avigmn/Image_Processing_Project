...
if __name__ == "__main__":
    print("Starting 128x128 DCT feature extraction...")
    ...
    for video_file in processed_videos:
        ...
        output_name = os.path.basename(video_file).replace("_processed_128.npy", "_original_128_features.npy")
        ...
        print(f"Extracting 128x128 DCT features from {os.path.basename(video_file)}...")
        video_array = np.load(video_file)
        features = extract_3d_dct_features(video_array)
